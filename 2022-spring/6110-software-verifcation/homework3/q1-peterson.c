...
static void swap_pid(struct state *s __attribute__((unused)), size_t x __attribute__((unused)), size_t y __attribute__((unused))) {
  if (((size_t)21ull) + x * ((size_t)3ull) != ((size_t)21ull) + y * ((size_t)3ull)) {
    raw_value_t a = handle_read_raw(s, state_handle(s, ((size_t)21ull) + x * ((size_t)3ull), 3ull));
    raw_value_t b = handle_read_raw(s, state_handle(s, ((size_t)21ull) + y * ((size_t)3ull), 3ull));
    handle_write_raw(s, state_handle(s, ((size_t)21ull) + y * ((size_t)3ull), 3ull), a);
    handle_write_raw(s, state_handle(s, ((size_t)21ull) + x * ((size_t)3ull), 3ull), b);
  }
  for (size_t i0 = 0; i0 < ((size_t)6ull); i0++) {
  }
  if (((size_t)39ull) + x * ((size_t)3ull) != ((size_t)39ull) + y * ((size_t)3ull)) {
    raw_value_t a = handle_read_raw(s, state_handle(s, ((size_t)39ull) + x * ((size_t)3ull), 3ull));
    raw_value_t b = handle_read_raw(s, state_handle(s, ((size_t)39ull) + y * ((size_t)3ull), 3ull));
    handle_write_raw(s, state_handle(s, ((size_t)39ull) + y * ((size_t)3ull), 3ull), a);
    handle_write_raw(s, state_handle(s, ((size_t)39ull) + x * ((size_t)3ull), 3ull), b);
  }
  for (size_t i0 = 0; i0 < ((size_t)6ull); i0++) {
  }
  for (size_t i0 = 0; i0 < ((size_t)7ull); i0++) {
    if (x != y) {
      raw_value_t v = handle_read_raw(s, state_handle(s, ((size_t)0ull) + i0 * ((size_t)3ull), ((size_t)3ull)));
      if (v != 0) {
        if (v - 1 == (raw_value_t)x) {
          handle_write_raw(s, state_handle(s, ((size_t)0ull) + i0 * ((size_t)3ull), ((size_t)3ull)), y + 1);
        } else if (v - 1 == (raw_value_t)y) {
          handle_write_raw(s, state_handle(s, ((size_t)0ull) + i0 * ((size_t)3ull), ((size_t)3ull)), x + 1);
        }
      }
    }
  }
  if (((size_t)57ull) + x * ((size_t)3ull) != ((size_t)57ull) + y * ((size_t)3ull)) {
    raw_value_t a = handle_read_raw(s, state_handle(s, ((size_t)57ull) + x * ((size_t)3ull), 3ull));
    raw_value_t b = handle_read_raw(s, state_handle(s, ((size_t)57ull) + y * ((size_t)3ull), 3ull));
    handle_write_raw(s, state_handle(s, ((size_t)57ull) + y * ((size_t)3ull), 3ull), a);
    handle_write_raw(s, state_handle(s, ((size_t)57ull) + x * ((size_t)3ull), 3ull), b);
  }
  for (size_t i0 = 0; i0 < ((size_t)6ull); i0++) {
  }
}
...
static int guard0(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"execute inc j and while\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
  ...
  const struct handle ru_P __attribute__((unused)) = state_handle(s, 21ull, 18ull);
  const struct handle ru_Q __attribute__((unused)) = state_handle(s, 39ull, 18ull);
  const struct handle ru_turn __attribute__((unused)) = state_handle(s, 0ull, 21ull);
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  return (handle_read("q1-peterson.m:67.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:67.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:67.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))) == VALUE_C(0)) ? 1 : 0;

}

static bool rule0(struct state *NONNULL s, struct handle ru_i) {
  static const char *rule_name __attribute__((unused)) = "rule \"execute inc j and while\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
  ...
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  {
  handle_write("q1-peterson.m:69.5-18: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:69.5-13: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:69.12: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(1));
  handle_write("q1-peterson.m:70.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:70.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:70.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(1));
  }
...
static int guard1(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"execute assign Qi j\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* this guard triggered an error */
      return -1;
  ...
  const struct handle ru_turn __attribute__((unused)) = state_handle(s, 0ull, 21ull);
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  return (handle_read("q1-peterson.m:74.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:74.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:74.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))) == VALUE_C(1)) ? 1 : 0;

}

static bool rule1(struct state *NONNULL s, struct handle ru_i) {
  static const char *rule_name __attribute__((unused)) = "rule \"execute assign Qi j\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* an error was triggered during this rule */
      return false;
  ...
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  {
  handle_write("q1-peterson.m:76.5-21: ", rule_name, "Q[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:76.5-8: ", rule_name, "Q[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_Q, handle_read("q1-peterson.m:76.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), handle_read("q1-peterson.m:76.13-21: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:76.13-21: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:76.20: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))));
  handle_write("q1-peterson.m:77.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:77.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:77.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(2));
  }
...
static int guard2(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"execute assign TURNj i\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* this guard triggered an error */
      return -1;
  ...
  const struct handle ru_turn __attribute__((unused)) = state_handle(s, 0ull, 21ull);
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  return (handle_read("q1-peterson.m:81.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:81.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:81.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))) == VALUE_C(2)) ? 1 : 0;

}

static bool rule2(struct state *NONNULL s, struct handle ru_i) {
  static const char *rule_name __attribute__((unused)) = "rule \"execute assign TURNj i\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* an error was triggered during this rule */
      return false;
  ...
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  {
  handle_write("q1-peterson.m:83.5-25: ", rule_name, "turn[localj[i]]", s, VALUE_C(0), VALUE_C(5), handle_index("q1-peterson.m:83.5-19: ", rule_name, "turn[localj[i]]", s, 3ull, VALUE_C(0), VALUE_C(6), ru_turn, handle_read("q1-peterson.m:83.10-18: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:83.10-18: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:83.17: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)))), handle_read("q1-peterson.m:83.25: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i));
  handle_write("q1-peterson.m:84.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:84.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:84.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(3));
  }
...
static int guard3(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"execute wait until\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* this guard triggered an error */
      return -1;
  ...
  const struct handle ru_turn __attribute__((unused)) = state_handle(s, 0ull, 21ull);
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  return (handle_read("q1-peterson.m:88.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:88.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:88.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))) == VALUE_C(3)) ? 1 : 0;

}

static bool rule3(struct state *NONNULL s, struct handle ru_i) {
  static const char *rule_name __attribute__((unused)) = "rule \"execute wait until\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* an error was triggered during this rule */
      return false;
...
if (!(!(handle_read("q1-peterson.m:91.14: ", rule_name, "k", s, VALUE_C(0), VALUE_C(5), ru_k) != handle_read("q1-peterson.m:91.17: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)) || (handle_read("q1-peterson.m:91.26-29: ", rule_name, "Q[k]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:91.26-29: ", rule_name, "Q[k]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_Q, handle_read("q1-peterson.m:91.28: ", rule_name, "k", s, VALUE_C(0), VALUE_C(5), ru_k))) < handle_read("q1-peterson.m:91.31-39: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:91.31-39: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:91.38: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)))))) { result = false; break; }    /* If this iteration runs right up to the type limits, the last
 ...
 result; }) || (handle_read("q1-peterson.m:93.12-26: ", rule_name, "turn[localj[i]]", s, VALUE_C(0), VALUE_C(5), handle_index("q1-peterson.m:93.12-26: ", rule_name, "turn[localj[i]]", s, 3ull, VALUE_C(0), VALUE_C(6), ru_turn, handle_read("q1-peterson.m:93.17-25: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:93.17-25: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:93.24: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))))) != handle_read("q1-peterson.m:93.31: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))) {
handle_write("q1-peterson.m:95.7-32: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:95.7-15: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:95.14: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), add("q1-peterson.m:95.20-32: ", rule_name, "(localj[i] + 1)", s, handle_read("q1-peterson.m:95.20-28: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:95.20-28: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:95.27: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))), VALUE_C(1)));
if (handle_read("q1-peterson.m:96.12-20: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:96.12-20: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_localj, handle_read("q1-peterson.m:96.19: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))) < VALUE_C(6)) {
handle_write("q1-peterson.m:98.9-18: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:98.9-12: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:98.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(1));
}
else  {
handle_write("q1-peterson.m:100.9-18: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:100.9-12: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:100.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(4));
}
;
}
;
...
static int guard4(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"execute critical and assign Qi 0\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* this guard triggered an error */
      return -1;
  ...
  const struct handle ru_turn __attribute__((unused)) = state_handle(s, 0ull, 21ull);
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  return (handle_read("q1-peterson.m:106.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:106.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:106.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i))) == VALUE_C(4)) ? 1 : 0;

}

static bool rule4(struct state *NONNULL s, struct handle ru_i) {
  static const char *rule_name __attribute__((unused)) = "rule \"execute critical and assign Qi 0\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* an error was triggered during this rule */
      return false;
  ...
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 57ull, 18ull);
  {
  handle_write("q1-peterson.m:108.5-13: ", rule_name, "Q[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:108.5-8: ", rule_name, "Q[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_Q, handle_read("q1-peterson.m:108.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(1));
  handle_write("q1-peterson.m:109.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:109.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:109.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(0));
  }
...
static bool startstate0(struct state *NONNULL s) {
  ...
  handle_write("q1-peterson.m:117.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:117.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:117.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(0));
  handle_write("q1-peterson.m:118.5-13: ", rule_name, "Q[i]", s, VALUE_C(0), VALUE_C(6), handle_index("q1-peterson.m:118.5-8: ", rule_name, "Q[i]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_Q, handle_read("q1-peterson.m:118.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(5), ru_i)), VALUE_C(0));
...
;
  ...
  for (raw_value_t _ru1_i = ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))); _ru1_i == ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))) || (lb < ub && ((value_t)(_ru1_i - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) <= ub) || (lb > ub && ((value_t)(_ru1_i - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) >= ub); _ru1_i += step) {
    ...
    struct handle ru_i = { .base = _ru2_i, .offset = 0, .width = ((size_t)3ull) };
    handle_write_raw(s, ru_i, _ru1_i);
  handle_zero(handle_index("q1-peterson.m:122.14-20: ", rule_name, "turn[i]", s, 3ull, VALUE_C(0), VALUE_C(6), ru_turn, handle_read("q1-peterson.m:122.19: ", rule_name, "i", s, VALUE_C(0), VALUE_C(6), ru_i)));
    /* If this iteration runs right up to the type limits, the last
     * increment will overflow and fail to terminate, so we guard
     * against that here.
     */
...
if ((((handle_read("q1-peterson.m:131.9-10: ", rule_name, "i1", s, VALUE_C(0), VALUE_C(5), ru_i1) != handle_read("q1-peterson.m:131.15-16: ", rule_name, "i2", s, VALUE_C(0), VALUE_C(5), ru_i2)) && (handle_read("q1-peterson.m:132.9-13: ", rule_name, "P[i1]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:132.9-13: ", rule_name, "P[i1]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:132.11-12: ", rule_name, "i1", s, VALUE_C(0), VALUE_C(5), ru_i1))) == VALUE_C(4))) && (handle_read("q1-peterson.m:133.9-13: ", rule_name, "P[i2]", s, VALUE_C(0), VALUE_C(4), handle_index("q1-peterson.m:133.9-13: ", rule_name, "P[i2]", s, 3ull, VALUE_C(0), VALUE_C(5), ru_P, handle_read("q1-peterson.m:133.11-12: ", rule_name, "i2", s, VALUE_C(0), VALUE_C(5), ru_i2))) == VALUE_C(4)))) { result = true; break; }    /* If this iteration runs right up to the type limits, the last
     * increment will overflow and fail to terminate, so we guard
     * against that here.
     */
    {
    ...
    {
{
  ...
  if (state_rule_taken_get(s) == rule_taken) {
    if (MACHINE_READABLE_OUTPUT) {
      put("<transition>");
      xml_printf("Rule \"execute inc j and while\"");
    } else {
      put("Rule \"execute inc j and while\"");
    }
    {
    ...
    {
{
  ...
  if (state_rule_taken_get(s) == rule_taken) {
    if (MACHINE_READABLE_OUTPUT) {
      put("<transition>");
      xml_printf("Rule \"execute assign Qi j\"");
    } else {
      put("Rule \"execute assign Qi j\"");
    }
    {
    ...
    {
{
  ...
  if (state_rule_taken_get(s) == rule_taken) {
    if (MACHINE_READABLE_OUTPUT) {
      put("<transition>");
      xml_printf("Rule \"execute assign TURNj i\"");
    } else {
      put("Rule \"execute assign TURNj i\"");
    }
    {
    ...
    {
{
  ...
  if (state_rule_taken_get(s) == rule_taken) {
    if (MACHINE_READABLE_OUTPUT) {
      put("<transition>");
      xml_printf("Rule \"execute wait until\"");
    } else {
      put("Rule \"execute wait until\"");
    }
    {
    ...
    {
{
  ...
  if (state_rule_taken_get(s) == rule_taken) {
    if (MACHINE_READABLE_OUTPUT) {
      put("<transition>");
      xml_printf("Rule \"execute critical and assign Qi 0\"");
    } else {
      put("Rule \"execute critical and assign Qi 0\"");
    }
    {
...
static void state_print_field_offsets(void) {
  ...
  put("-byte aligned\n");
  put("	* field P is located at state offset 21 bits\n");
  put("	* field Q is located at state offset 39 bits\n");
  put("	* field turn is located at state offset 0 bits\n");
  put("	* field localj is located at state offset 57 bits\n");
  put("\n");
}
